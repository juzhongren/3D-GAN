...
class Discriminator(nn.Module):
    ...
    def __init__(self, ngpu, cube_size=64):
        ...
        self.main = nn.Sequential(
            ...
            nn.Conv3d(num_features, num_features, kernel_size=1, stride=2, bias=False),
            ...
            nn.Conv3d(num_features, 2 * num_features, kernel_size=1, stride=1, bias=False),
            ...
            nn.Conv3d(2 * num_features, 2 * num_features, kernel_size=1, stride=2, bias=False),
            ...
            nn.Conv3d(2 * num_features, 4 * num_features, kernel_size=1, stride=1, bias=False),
            ...
            nn.Conv3d(4 * num_features, 4 * num_features, kernel_size=1, stride=2, bias=False),
            ...
            nn.Conv3d(4 * num_features, 8 * num_features, kernel_size=1, stride=1, bias=False),
            ...
            nn.Conv3d(8 * num_features, 8 * num_features, kernel_size=1, stride=2, bias=False),
